...
import { GraduationCap , Clock, Calendar, ExternalLink, Star, Quote, X, Play } from 'lucide-react';
import { useRouter } from 'next/navigation';

const categories = ["FullStack Develpment", "Digital Marketing", "App Development", "Scrum Master", "Cyber Security"];
...
const testimonials = [
  {
    ...
    quote: "The Full-Stack Web Development course teaches you to build dynamic web applications by mastering both frontend and backend technologies.",
  ...
  },
  {
    ...
    quote: "The Advanced Digital Marketing course covers essential strategies like SEO, social media marketing, PPC advertising, email marketing, and analytics to help businesses grow online.",
  ...
  },
  {
    ...
    quote: "The Mobile App Development course teaches you how to build powerful iOS and Android applications using modern frameworks like React Native and Flutter.",
  ...
  },
  {
    ...
    quote: "The Scrum Master course equips you with the skills to lead agile teams, enhance collaboration, and drive efficient project delivery.",
  ...
  },
  {
    ...
    quote: "The Cyber Security course teaches you how to protect systems, networks, and data from cyber threats. You'll learn about ethical hacking, encryption, risk management, and threat detection. ",
...
export default function Courses() {
  ...
  const handleViewProgram = (courseType) => {
    router.push(`/register?course=${courseType}`);
  };
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="block w-full bg-violet-600 text-white text-center font-semibold py-3 rounded-xl hover:bg-violet-700 transition-colors duration-200 flex items-center justify-center gap-2"
                  >
                    View Program
      ...
      <div className="mt-20 bg-gray-50 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold text-violet-600 mb-6">
                ...
                {activeVideo === testimonial.id ? (
                  ...
                  <div className="p-8">
                    ...
                    <div className="relative">
                      ...
                      <blockquote className="text-gray-700 pl-6 relative z-10">
                        {testimonial.quote}
                      </blockquote>
                    </div>
                  </div>
